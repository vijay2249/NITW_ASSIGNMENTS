...
// 	printf("Inside the remove_sublist function\n");
...
// 	printf("Inside the quicksort function\n");
// 	int i, n, pivot;
// 	int lo, hi;
// 	quicksort_1:
// 	if (end <= start) return; // Invalid list or single element
// 	//printf("Quick sort called : %d, %d, (%d, %d)\n",start,end,head,tail);
// 	if ((tail % 50) == 0) printf("Quick sort called : %d, %d, (%d, %d)\n",start,end,head,tail);
// 	if ((end - start + 1) < MINIMUMSIZE) insertionsort(start, end);
// 	else{
...
// 	printf("Inside the thread_func function\n");
// 	struct sublist s;
// 	int done = 0;
// 	int fd;
// 	int procno;
...
// 	// Create threads.	
// 	t1 = clock();	
// 	for (i=1; i<P; i++) pthread_create(&thr[i], NULL, thread_func, &args[i]);
// 	t2 = clock();
// 	thread_func(&args[0]);
// 	t3 = clock();	
// 	for (i=1; i<P; i++) pthread_join(thr[i], NULL);
// 	t4 = clock();	
// 	//	for (i=0; i<N; i++) printf("%8d",A[i]);
// 	printf("\nTime elapsed : creation %d, sort : %d, joining : %d\n",t2-t1, t3-t2, t4-t3);
// 	printf("Total Time elapsed: %d", t4-t1);
// 	return 0;
// }
...
int main(int argc, char **argv){
	...
	// for (i=0; i<N; i++)
		// printf("%8d",A[i]);
	// printf("Time elapsed : creation %d, sort : %d, joining : %d\n",t2-t1, t3-t2, t4-t3);
